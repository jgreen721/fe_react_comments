  ...
  return (
    <div className={showDeleteModal ? "delete-edit-overlay" : "delete-edit-overlay hide-overlay"}>
        <div className="delete-edit-card">
            ...
            <h5 className="delete-modal-blurb">Are you sure you want to delete this comment? This will remove the comment and <span className="underline bold">can't</span> be undone!</h5>
